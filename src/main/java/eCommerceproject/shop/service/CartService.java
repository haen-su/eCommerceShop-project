...
import eCommerceproject.shop.repository.CartItemRepository;
import eCommerceproject.shop.repository.CartRepository;
...
public class CartService {
    ...
    public void updateCartCount(Long cartItemId, int count) {
        CartItem cartItem = cartItemRepository.findById(cartItemId).orElseThrow(EntityNotFoundException::new);
